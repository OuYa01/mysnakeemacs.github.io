...
bombImg.src = './img/snake/head.svg';
...
function drawScore() {
  ...
  return scoreCount; // add this line to return the score count
}
...
// set best score once when the page loads
...
function shareOnTwitter() {
    ...
    const tweetText = `I just scored ${bestScore} points in @OussamaLaamri snake emacs game! Can you beat my score and help #teamEmacs? Play: www.snakemacs.com @julienbarbier42`;
    const shareUrl = `https://twitter.com/intent/tweet?url=&text=${encodeURIComponent(tweetText)}`;
